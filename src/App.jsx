...
{ title:"Counter-Strike 2",price:"Free",image:"https://tamhongame.net/storage/games/counter-strike-2-online-multiplayer/counter-strike-2-online-multiplayer-vertical_photo-0NQZisZoNB3jqYbdxkop.jpeg"},
{ title:"Resident Evil 4",price:"Free",image:"https://media.senscritique.com/media/000021509526/0/resident_evil_4.png"},
...
<div key={index} className="bg-[#0b121c] p-4 rounded-xl border border-gray-800 hover:scale-105 hover:border-blue-500/50 hover:shadow-[0_0_30px_rgba(37,99,235,0.4)] transition">
    ...
    <p className="text-blue-400 font-bold text-xl">{game.price}</p>
