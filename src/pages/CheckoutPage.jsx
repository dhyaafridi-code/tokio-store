...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-brand text-white p-10">
      ...
      <div className="max-w-3xl mx-auto bg-surface p-6 rounded-xl border border-gray-200/10">

        <h2 className="text-xl mb-4 text-white">Order Summary</h2>
        ...
        <button
          ...
          className="mt-6 w-full bg-primary hover:bg-primary/90 py-2 rounded-lg text-white"
        >
          Pay Now
        </button>
