    ...
    <div className="min-h-screen bg-surface flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-7">
          <div className="w-14 h-14 mx-auto bg-gradient-to-tr from-primary to-accent rounded-xl flex items-center justify-center mb-4 shadow-lg neon-glow">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <div className="relative mt-1.5">
              ...
              <input
                ...
                className="w-full bg-neutral-100/5 border border-gray-200/10 rounded-lg py-3 pl-10 pr-4 text-sm text-white placeholder:text-muted focus:outline-none focus:border-primary/50"
          ...
          <div>
            ...
            <div className="relative mt-1.5">
              ...
              <input
                ...
                className="w-full bg-neutral-100/5 border border-gray-200/10 rounded-lg py-3 pl-10 pr-10 text-sm text-white placeholder:text-muted focus:outline-none focus:border-primary/50"
                placeholder="••••••••"
              />
          ...
          <button className="w-full bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-white font-bold py-3.5 rounded-xl shadow-lg active:scale-[0.98] flex items-center justify-center gap-2 neon-glow">
        ...
        <p className="text-muted text-sm text-center mt-6">
          ...
          <Link to="/register" className="text-accent ml-2 hover:underline">Register</Link>
        </p>
      </motion.div>
      <Signature />
    </div>
